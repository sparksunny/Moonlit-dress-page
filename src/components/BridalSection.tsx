...
export const BridalSection: React.FC<BridalSectionProps> = ({ dresses, onViewDetails }) => {
  return (
    <section
      id="bridal"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#EFE6DA]/80 border border-[#E3D6C5]">
            ...
            <span className="font-cormorant italic text-xs text-[#7B6451]">Haute Couture</span>
          </div>
          ...
          <p className="font-cormorant italic text-lg sm:text-xl text-[#78614E]">
            Timeless beauty for your most unforgettable moments.
          </p>
        ...
        {/* Catalog Grid: 8 Bridal Dress Cards */}
