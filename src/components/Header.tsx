    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 sm:h-24">
          ...
          {/* Desktop Navigation (ONLY Home, About, Bridal Dresses, Party Wear, Contact) */}
          <nav
          ...
          {/* Small decorative botanical accent & Download HTML action on desktop */}
          <div className="hidden lg:flex items-center gap-4">
            <a
              id="header-download-html-btn"
              href="/moonlit-closet.html"
              download="moonlit-closet.html"
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#EFE6DA] hover:bg-[#E5D7C7] text-[#342217] text-[11px] uppercase tracking-[0.16em] font-semibold border border-[#DFCDBB] shadow-2xs transition-all hover:scale-102"
              title="Download standalone HTML file to run offline on your PC"
            >
              <Download className="w-3.5 h-3.5 text-[#866649]" />
              <span>Download HTML</span>
            </a>
            <div className="text-[#B89B7A] opacity-60">
              <BotanicalBranch className="w-7 h-7 rotate-12" />
            </div>
          </div>

          {/* Compact Mobile Navigation Button */}
          <div className="flex md:hidden items-center gap-2">
            <a
              href="/moonlit-closet.html"
              download="moonlit-closet.html"
              className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#EFE6DA] text-[#342217] text-[10px] uppercase tracking-wider font-semibold border border-[#DFCDBB]"
              title="Download HTML"
            >
              <Download className="w-3 h-3 text-[#866649]" />
              <span>HTML</span>
            </a>
            <button
              ...
              className="p-2.5 rounded-md text-[#342217] hover:bg-[#F2EAE0] transition-colors focus:outline-hidden"
