...
export const PartyWearSection: React.FC<PartyWearSectionProps> = ({ dresses, onViewDetails }) => {
  return (
    <section
      id="party-wear"
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#EAE0D4]/80 border border-[#DDD0C0]">
            <span className="text-[10px] uppercase tracking-[0.25em] text-[#654E3C] font-semibold">
              Evening & Festive Formal
            </span>
            <span className="text-[#C5A880]">✦</span>
            <span className="font-cormorant italic text-xs text-[#7B6451]">Modern Silhouettes</span>
          </div>
          ...
          <p className="font-cormorant italic text-lg sm:text-xl text-[#755F4C]">
            Graceful looks designed to make every celebration memorable.
          </p>
        ...
        {/* Catalog Grid: 8 Party Wear Cards */}
